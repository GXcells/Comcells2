...
class SaveAudio:
    ...
    def INPUT_TYPES(s):
        return {"required": { "audio": ("AUDIO", ),
                              "filename_prefix": ("STRING", {"default": "audio/Comcells2"})},
    ...
    def save_audio(self, audio, filename_prefix="Comcells2", prompt=None, extra_pnginfo=None):
