...
from comcells2.ldm.modules.diffusionmodules.mmdit import (
    Mlp,
    TimestepEmbedder,
    PatchEmbed,
    RMSNorm,
)
from comcells2.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanControlNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.norm = norm
        self.dtype = dtype
        self.latent_format = comcells2.latent_formats.SDXL
    ...
    def forward(
        ...
        **kwarg,
        ...
        padding = comcells2.ops.cast_to_input(self.text_embedding_padding, text_states)
