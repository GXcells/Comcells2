...
ident = pygit2.Signature('comcells2ui', 'comcells2@ui')
try:
...
stable_update_script = os.path.join(repo_path, ".ci/update_windows/update_comcells2ui_stable.bat")
stable_update_script_to = os.path.join(cur_path, "update_comcells2ui_stable.bat")
