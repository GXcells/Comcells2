...
from comcells2_execution.graph import get_input_info, ExecutionList, DynamicPrompt, ExecutionBlocker
from comcells2_execution.graph_utils import is_link, GraphBuilder
from comcells2_execution.caching import HierarchicalCache, LRUCache, CacheKeySetInputSignature, CacheKeySetID
...
def execute(server, dynprompt, caches, current_item, extra_data, executed, prompt_id, execution_list, pending_subgraph_results):
    ...
    try:
    ...
    except comcells2.model_management.InterruptProcessingException as iex:
        ...
        if isinstance(ex, comcells2.model_management.OOM_EXCEPTION):
            logging.error("Got an OOM, unloading all loaded models.")
            comcells2.model_management.unload_all_models()
...
class PromptExecutor:
    ...
    def handle_execution_error(self, prompt_id, prompt, current_outputs, executed, error, ex):
        ...
        if isinstance(ex, comcells2.model_management.InterruptProcessingException):
            mes = {
                "prompt_id": prompt_id,
                "node_id": node_id,
                "node_type": class_type,
    ...
    def execute(self, prompt, prompt_id, extra_data={}, execute_outputs=[]):
        ...
        with torch.inference_mode():
            ...
            comcells2.model_management.cleanup_models(keep_clone_weights_loaded=True)
            ...
            if comcells2.model_management.DISABLE_SMART_MEMORY:
                comcells2.model_management.unload_all_models()
